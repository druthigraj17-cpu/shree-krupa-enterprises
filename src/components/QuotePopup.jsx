  ...
  return (
    <div className="popup-overlay show" onClick={(e) => { if (e.target === e.currentTarget) setShow(false); }}>
      <div className="popup">
        ...
        <form
          action="https://formsubmit.co/shreekripaenterprises.blr@gmail.com"
          method="POST"
        >
          <input type="hidden" name="_subject" value="New Quote Request from Shree Krupa Website" />
          <input type="hidden" name="_captcha" value="false" />
          <input type="hidden" name="_template" value="table" />
          <input type="hidden" name="_next" value="https://www.shreekrupaenterprise.in/" />
